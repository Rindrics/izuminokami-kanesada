...
interface AudioManifestEntry {
  ...
  ja?: AudioFileMetadata; // Optional: preserved for existing entries, not generated by TTS
}
...
function updateManifestEntry(
  ...
  manifest[contentId] = {
    ...
    // Preserve existing ja entry if present (for manual recordings)
    ...(existingEntry?.ja && { ja: existingEntry.ja }),
  };
}
